...
const CompanyDetailEmployer = ({ res }) => {
    ...
    <div className='rounded-xl overflow-hidden'>
        <div className='bg-blue-700 p-4 flex justify-between'>
            <p className='text-lg text-white'>Profile</p>
            <div>
                <button className='text-sm bg-teal-600 py-1 px-2 rounded-md hover:bg-teal-700 text-white mr-1' onClick={handleUpdate}>Update</button>
                <button className='text-sm bg-red-600 py-1 px-2 rounded-md text-white ml-1 hover:bg-red-700' onClick={handleDelete}>Delete</button>
            </div>
        </div>
