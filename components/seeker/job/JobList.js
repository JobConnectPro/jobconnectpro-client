          ...
          <div className="py-4 gap-2 border-b border-slate-200">
            <form onSubmit={handleSubmit} className="flex">
              <div className="relative flex-grow">
                ...
                <input type="search" defaultValue={searchQuery} id="default-search" name="search" className="block w-full px-4 py-2 text-gray-900 rounded-lg" placeholder="Search jobs by title..." />
              </div>
