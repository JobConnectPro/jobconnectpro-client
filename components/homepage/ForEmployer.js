export default function ForEmployer() {
  return (
    <div className="w-full p-4 items-center mx-auto bg-white py-10">
      <div className="w-full items-center bg-blue-400 rounded-xl mx-auto bg-[url('../public/owner.png')]">
        <div className="flex flex-col text-white p-4">
          ...
          <div className="w-full grid grid-cols-3 gap-14 py-0 pt-4">
            <p className="bg-blue-500  rounded-md text-3xl p-8 font-semibold">Post a job and hire a pro</p>
            <p className="bg-blue-500  rounded-md text-3xl p-8 font-semibold">Browse and buy project</p>
