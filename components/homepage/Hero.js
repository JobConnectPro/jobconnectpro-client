    ...
    <div className="flex">
      <div className="w-full py-4 px-8 mx-auto grid md:grid-cols-2">
        <div className="flex flex-col justify-center">
          ...
          <h1 className="md:text-5xl sm:text-3xl text-2xl font-bold text-slate-400 py-5">
            Career opportunities
          </h1>
          <h1 className="md:text-7xl sm:text-3xl text-2xl font-bold text-slate-600 py-9 pb-16">
            With jobconnect
          </h1>
